...
public class WeekndExam {
    ...
    public static void addArray(int[] arrayNumber) {
        String mess = "value element is number";
        int size = arrayNumber.length;
        for (int i = 0; i < size; i++) {
            System.out.println("The element in place " + (i + 1) + " of array ");
            arrayNumber[i] = checkInputNumber(mess);
        }
        System.out.println();
    }
    ...
    public static void isExitElementArrays(int[] arrNumber) {
        ...
        int finNumber = checkInputNumber(mess);
        for (int i = 0; i < arrNumber.length; i++) {
            if (arrNumber[i] == finNumber) {
                System.out.println("Element has value " + finNumber + "is position: " + (i + 1));
                checkExits = false;
            }
        }
        if (checkExits) System.out.println("Element has value " + finNumber + " not exits arrays");
    }
    ...
    public static void deleteElementValue(int[] arrNumber) {
        ...
        if (isExits) {
            System.out.println("Value of element no exits in array");
        } else {
